...
//
//			for (int beta : betas) {
//				MarkovChain Roby.markov = new MarkovChain(numPeriodsBRP, 2000, twoComponents, alpha, beta);
...
//
//					PBRP pBRP = new PBRP(twoComponents, costs, Roby.markov, r, true);
...
//		}
	 ...
	 *                   time-varying costs
	 * @param markov     the Roby.markov chain corresponding to the component(s)
