...
public class MBRPgetFullPolicy {
    public final Instance instance;
    public final int[][][] actions;
    public static boolean actionsNotFulfilled;
    public final String folderName;

    public MBRPgetFullPolicy(Instance instance, String folderName) throws IOException, IloException {
        ...
        while(actionsNotFulfilled){
            ...
            ModelMBRP_warmstart getNewPolicy = new ModelMBRP_warmstart(instance, fileName2, MBRP2comp.actions);
