...
public class ModelMBRP_warmstart extends ModelARP {
    final int[][][] actions;

    public ModelMBRP_warmstart(Instance instance, String fileName, int[][][] actions) throws IloException, IOException {
